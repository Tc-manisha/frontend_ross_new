...
export default function AedSupport({stateData}){
  ...
  return (
    <>
     ...
     {!loading && ( <>
      {/* heading */}
      <Box className="text-left pt-1 pb-1 d-flex justify-content-end mb-2" >
        {/* <h4 className='heading'>Meep Fitness Rickenbacker</h4> */}
        <button className='btn' 
        style={{marginTop: '10px',textDecoration: 'none',backgroundColor:"transparent",border:"transparent",color:"#0C71C3"}}
         onClick={()=>{
