...
import { FormatDate, GetProfile, RenderWithOutZero, getPermission } from "../../../helper/Common";
import moment from "moment";
import { FetchAccountDetails } from "../../../helper/BasicFn";
import Loading from "../../../pages/accounts/Loading";
import { UserInpersonTab, UserPopTabs } from "../../../utils";
...
const UserPopDetails = () => {
    ...
    const filterTabsArray = () => {
        ...
        const filteredPopTabs = filteredDetailsTabs(UserPopTabs)

        // filteredPopTabs.unshift({ name: 'Details', id: 'pop-details', 'order': 1 })
                ...
                <div className="mt-4" style={{ width: "100%", paddingInline: "45px" }}>
                   ...
                   {console.log({filteredTabs})}
                    ...
                    {filteredTabs.hasOwnProperty('Documents') && currentTab === filteredTabs.Documents && (
                        <>
                            <Documents is_user={true} privileges={privileges} account_id={account_id} type={"Documents"}/>
                        </>
                    )}

                    {filteredTabs.hasOwnProperty('Notes') && currentTab === filteredTabs.Notes && (
                        <>
                            <Notes is_user={true} privileges={privileges} account_id={account_id} />
                        </>
                    )}
