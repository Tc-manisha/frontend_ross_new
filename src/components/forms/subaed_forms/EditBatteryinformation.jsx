...
function EditBatteryinformation({
  crrIndex,
  formData,
  setFormData,
  keyName,
      ...
      <>
        <div class="row" key={crrIndex}>
          ...
          <div className="col-3 form-group">
            ...
            {/* <input className='form-control' type="text" id="" value={HandleUnknow( formData?.[ keyName ]?.[ crrIndex ]?.battery_uid) } onChange={ (e) => handleInputChange(e, crrIndex) } disabled={is_unknowntrue} name="battery_udi"  /> */}
            <input
              className="form-control"
              type="text"
              id=""
      ...
      <div className="row" key={crrIndex}>
        ...
        <div className="col-3 form-group">
          ...
          <input
            ...
            type="text"
            id=""
            value={HandleUnknow(formData?.[keyName]?.[crrIndex]?.battery_uid)}
            onChange={(e) => handleInputChange(e, crrIndex)}
            disabled={is_unknowntrue}
            name="battery_udi"
          />
...
export default EditBatteryinformation;
