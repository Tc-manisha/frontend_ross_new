...
function MainContactModalEmail({SaveForm,open,hanldeModal,emailDataList,phoneDataList,dataType,setSubFormData,setDataType}) {
            ...
            <Form.Group className={ 'col d-block' }>
              ...
              <div className="">
                <FormControlLabel
                  ...
                  control={ <Radio color="primary" size="medium" checked = { single.main == 1 || single.main ? true : false } /> }
                />
...
export default MainContactModalEmail;