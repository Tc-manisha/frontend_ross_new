...
function EditMoveAedPlacement({ id,show, onHide, aedDetails, onSave }) {
  ...
  return (
    <>
      ...
      <Modal.Header closeButton>
        <Modal.Title>Edit AED Placement</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <Form onSubmit={handleSubmit}>
          <Form.Group controlId="location">
            <Form.Label>AED Placement</Form.Label>
            <Form.Control
              type="text"
              name="location"
...
export default EditMoveAedPlacement