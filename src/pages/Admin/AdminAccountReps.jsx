...
import "../../components/modals/ProductModal/productModal.scss";
...
export default function AdminAccountReps({
  ShowRepsModal,
  SetShowRepsModal,
  setAccReps,
  AccReps,
  ...
  const handleNewSiteRepsSubmit = async () => {
    ...
    setAdminAccountModelData(site_reps);
    handleClose();
  };
