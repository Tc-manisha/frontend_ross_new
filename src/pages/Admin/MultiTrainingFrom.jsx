            ...
            <div className="col-4">
              ...
              <Form.Group className={"col"}>
                <Form.Control
                  ...
                  onChange={(e) => updateFieldChanged(e, index, 'account_alternate_traning_location_company_name')}
                />
              </Form.Group>
            </div>
          ...
          <div className="row my-4">
            ...
            <Form.Group className={"col"}>
              ...
              <Form.Control
                ...
                onChange={(e) => updateFieldChanged(e, index, 'account_alternate_traning_location_address1')}
              />
              <Form.Control.Feedback type="invalid">
            ...
            <Form.Group className={"col"}>
              ...
              <Form.Control
                ...
                onChange={(e) => updateFieldChanged(e, index, 'account_alternate_traning_location_address2')}
              />
            </Form.Group>
            ...
            <Form.Group className={"col"}>
              ...
              <Form.Control
                ...
                onChange={(e) => updateFieldChanged(e, index, 'account_alternate_traning_location_city')}
              />
              <Form.Control.Feedback type="invalid">
                Please Enter City.
              </Form.Control.Feedback>
            ...
            <Form.Group className={"col"}>
              ...
              <Form.Control
                ...
                required
                onChange={(e) => updateFieldChanged(e, index, 'account_alternate_traning_location_zipcode')}
              />
              <Form.Control.Feedback type="invalid">
