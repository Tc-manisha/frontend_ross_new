...
export default function Notes({ accountId, site_id = 0, contact_id = 0, type = 'ACCOUNT', setTabTbldata })
{
	...
	const handleRender = (e) =>
	{
		...
		return <Link to={ `/account/note/${ e.data.notes_id }` } className="text-primary link" style={{textDecoration:"none"}} >{ e.value }</Link>
	...
	return (
		<div className='relative'>
            ...
            /> */}
						<Link className='text-primary new-btn' to={ redirectUrl } style={{ textDecoration: 'none', display:"flex",flexDirection:"row" }} >
