...
import { FormatDate, FormatDateWithTime } from '../../../../helper/Common';
                ...
                <tbody>
                    ...
                    <tr className="">
                        <td className=" py-1 px-2 border-r-blue border-b-blue">
                            {accountDetails?.parent_account_id ? <>
                                <Link className='link' style={{textDecoration:"none"}} to={'/account-details/' + accountDetails?.parent_account_id}>{ accountDetails?.parent_account }</Link>
                            </> : ''}
                        </td>
                        <td className=" py-1 px-2 border-r-blue border-b-blue" colSpan="2">
                            {accountDetails?.distributor_account_id ? <>
                                <Link className='link' style={{textDecoration:"none"}} to={'/account-details/' + accountDetails?.distributor_account_id}>{ accountDetails?.distributor_account }</Link>
                            </> : ''}
                        </td>
                    ...
                    <tr className="">
                        ...
                        <td className=" py-1 px-2 border-b-blue" colSpan="3">
                            ...
                            <a className='link' style={{textDecoration:"none"}} href={ !httpsWeb ? 'https://' + accountDetails?.website : accountDetails?.website } target='_blank' >
                ...
                <tbody>
                  ...
                  <tr>
                    { CoordiDataList?.map((CoorD, i1) => (
                      <td className="py-1 px-2 border-r-blue" key={i1}> P: 
...
<ContactName 
                          url={  '/account/' + accountDetails?.account_id + '/contact-details/' + CoorD?.arr?.[ 0 ]?.contact_id || CoorD?.arr?.[ 1 ]?.contact_id }
              ...
              >
                <p>
                  ...
                  {accountDetails?.created_date ? (
                    <Moment
                      date={accountDetails?.created_date}
                ...
                <p>Created By: {accountDetails?.created_by}</p>
                <p>
                  Modified Date:{" "}
                ...
                <p>Modified By: {accountDetails?.modified_by}</p>
                <p>
                  Last Touch Date:{" "}
                  {accountDetails?.last_check
                    ? FormatDate(accountDetails?.last_check)
                    : ""}
                </p>
              </Box>
            </div>
