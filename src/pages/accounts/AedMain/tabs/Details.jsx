          ...
          <table className="w-100">
            ...
            <tbody className="odd-even-row border-b-blue">
              <tr className="">
                ...
                <td className="border border-2 py-1 px-2 bg-tbl-border">
                  {outOfServiceInfo[0]?.loaner_rental_serial}
                </td>
                <td className="border border-2 py-1 px-2 bg-tbl-border">
          ...
          <tbody>
            ...
            <tr>
              {cordinatorInfo.map((CoorD, i1) => (
                <td className="border py-1 px-2 border-r-blue" key={i1}>
                  {" "}
                  P:{" "}
                  <ContactName 
                          url={  
            ...
            <tr>
              {cordinatorInfo.map((CoorD, i1) => (
                <td
                  className=" border bg-tbl-border py-1 px-2 border-b-blue border-r-blue"
                  key={i1}
                >
                  {" "}
                  B:
