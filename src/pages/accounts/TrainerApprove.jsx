...
export default function TrainerApprove() {
    ...
    const handleApprove = async(value) => {
        ...
        let isPrimary = searchParams.get("is_primary");
        let isBackup = searchParams.get("is_backup");
        let url = 'account/trainer-approval-for-class?class_id=' + classId + '&contact_id=' + contactId + '&is_primary=' + isPrimary + '&is_backup=' + isBackup + '';
